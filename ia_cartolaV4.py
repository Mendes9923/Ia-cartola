...
df = df.sort_values(by=["Finalizações Defendidas (FD)", "Desarmes (DS)"], ascending=[False, False])
...
saida_df.to_excel("times_recomendados_v4.xlsx", index=False)
print("Arquivo 'times_recomendados_v4.xlsx' gerado com sucesso!")
